      ...
      return {
        ...
        text: [
          ...
          "FILL_DEBUG " + safeText(JSON.stringify({
            ...
            domText: safeText(domFallback.text || "", 3000),
            domError: safeText(domFallback.error || "", 1000),
            verifierText: safeText(verifyAfterDom.text || "", 3000),
            verifierError: safeText(verifyAfterDom.error || "", 1000),
          }), 8000),
